...
describe Accommodation do
  ...
  it 'should not accept an invalid email' do
    accommodation = Accommodation.make email: 'test@test'
    accommodation.should_not be_valid
  end

  it 'should accept a vaild email' do
    accommodation = Accommodation.make email: 'test@test.com'
    accommodation.should be_valid
  end

  it 'should not accept an invalid phone number' do
    accommodation = Accommodation.make phone_home: "12345"
    accommodation.should_not be_valid
  end

  it 'should not accept characters as a phone number' do
    accommodation = Accommodation.make phone_home: "ab cdef ghij"
    accommodation.should_not be_valid
  end

  it 'should accept empty phone numbers' do
    accommodation = Accommodation.make phone_home: "",
      phone_mobile: "",
      other_phone: ""
    accommodation.should be_valid
  end
  ...
  describe :authorization_token do
    ...
    it 'should reply with a short string' do
      @accommodation.authorization_token.length.should == 23
    end
